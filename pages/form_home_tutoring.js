...
function FormHomeTutoring() {
    ...
    return (
      <div>
        <Head>
          <title>QDS Pro Coaching Institute | Home Tutoring </title>
          <meta
            name="description"
            content="QDS Pro provides home tutoring services. We receive ample of inquiries on a daily basis from across Mumbai. Collaborate with us to be a home tutor."
          />
        </Head>
        <style>
          {`
                  ...
                  <div ref={myRef} className="contact-us-form clearfix ">
                    ...
                    <div className="form-wrapper">
                      ...
                      <p
                        ...
                        className="mt-5 mb-5"
                      >
                        QDS Pro provides home tutoring services. We receive
                        ample of inquiries on a daily basis from across Mumbai.
                        So, we are looking forward to collaborate with you on
                        this fruitful journey of fulfilling student
                      ...
                      <div>
                        <form
                          ...
                          action="https://formspree.io/xbjzbgbq"
                        >
                          <input
                            hidden
                            type="text"
                            name="Form Title"
                            value="Join us as a Home Tutor"
                          />
                          ...
                          <div className="form-group">
                            <label for="preferable_locations">
                              Prefereble locations for home tutoring{" "}
                              <span className="required-field">*</span>{" "}
                            </label>
                            <input
                              required
                              type="text"
                              className="form-control"
                              name="preferable_locations"
                              id="preferable_locations"
                              placeholder="Your answer"
                            />
                          </div>

                          <label for="type_of_service">
                            Type of service that you would like to offer?
                            <span className="required-field">*</span>{" "}
                          </label>
                          <div className="radio-div">
                            <div class="form-check">
...
export default FormHomeTutoring;