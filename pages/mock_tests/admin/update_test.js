...
class UpdateTest extends Component
{
    ...
    handleSectionDetailChange = (event, index) => {
    ...
    handleSectionDetails = () => {
        ...
        var proceed = true;
            ...
            var nameTempArr = this.state.section_names;
            var timeTempArr = this.state.section_time;
            var tempTotalTime = 0;
            ...
            for(let j = 0; j < this.state.n_sections; j++ )
            {
                tempTotalTime += timeTempArr[j];
            }
    ...
    handleSubmit = (event) => {
        ...
        if(this.state.course !== this.props.router.query.course)
        {
            ...
            .then((docSnapshot) => {
                ...
                {
                    mockTestFireStore.collection(this.props.router.query.course).doc(this.props.router.query.name).delete()
                    .then(() => {

                        mockTestFireStore.collection(testObj.course).doc(testObj.name).set(testObj)
                        .then(() => alert("Test "+ testObj.name + " Updated Successfully"))
                        .catch(err => {
        ...
        else if(this.state.name !== this.props.router.query.name)
        {
            mockTestFireStore.collection(testObj.course).doc(testObj.name).get()
            .then((docSnapshot) => {
        ...
        // .catch(err => {
        //     alert("Error Updating the test " + testObj.name + ": " + err);
        //     // console.log(err);
        // });
                ...
                <div className="container-fluid dashboard-nav p-2">
                    <div className="row p-3 text-white">
                        <div className="col-10 d-flex pl-4">
                            ...
                            <h4 className="welcomeText align-self-center pl-3">Update test: {this.state.name}</h4>                    
                        </div> 
                ...
                <div className="container-fluid content-container">
                    <div className="row">
                        <div className="col-12">
                            <h2 className="welcomeText">Update the following details.</h2>
                        </div>
                    </div>
                    <form className="mt-3 ml-3" onSubmit={this.handleSubmit}>
                        <div className="form-row">
                            <div className="form-group col-sm-4">
                                ...
                                <input required type="text" className="form-control" name="name" id="name" placeholder="Name of the test" onChange={this.handleChange} value={this.state.name}></input>
                            </div>
                            <div className="form-group col-sm-4">
                                <label htmlFor="course">Course{' '}</label>
                                <select required name="course" id="course" className="form-control" onChange={this.handleChange} value={this.state.course}>
                            ...
                            <div className="form-group col-sm-4">
                                ...
                                <input readOnly required type="number" className="form-control" name="n_sections" id="n_sections" placeholder="Number of Sections" onChange={this.handleChange} value={this.state.n_sections}></input>
                            </div>
                        </div>
                        {
                            this.state.sectionArr.length > 0 && (
                                ...
                                
                                {
                                    ...
                                    return(
                                            <div className="form-row">
                                                <div className="form-group col-sm-4">
                                                    <label htmlFor="section_name">Name of the Section{' ' + (i+1)} | Current Name = {this.state.section_names[i]}</label>
                                                    <input type="text" className="form-control" name="section_names" id={"section_name_" + (i+1)} placeholder="Section Name"></input> 
                                                </div>
                                                <div className="form-group col-sm-4">
                                                    <label htmlFor="section_time">Time for the Section{' ' + (i+1)} (in minutes) | Current Time = {this.state.section_time[i]}</label>
                                                    <input type="number" className="form-control" name="section_time" id={"section_time_" + (i+1)} placeholder="Section Time (in minutes)"></input> 
                                                </div>
                                                <div className="form-group col-sm-4">
                                                    <label htmlFor="section_n_questions">Number of questions for the Section{' ' + (i+1)}</label>
                                                    <input readOnly required type="number" className="form-control n_questions" name="section_n_questions" id={"section_n_questions_" + (i+1)} placeholder="Number of Questions" value={this.state.section_n_questions[i]}></input> 
                                                </div>
                                            </div>
                                        );
                                    })
                                            ...
                                            <h4 className="welcomeText">Section {i+1} : {this.state.section_names[i]}</h4>
                                                <div className="form-row">
                                                        ...
                                                        return(
                                                            <div>
                                                                ...
                                                                <div className="form-group col-sm-12">
                                                                    ...
                                                                    <select required name="questionType" id={"questionType" + (i+1) + "." + (j+1)} className="form-control" onChange={(e) => this.handleQuestions(e, i, j)} value={this.state.questionsArr[i][j].questionType}>
                                                                ...
                                                                <div className="form-group col-sm-12">
                                                                    ...
                                                                    <textarea name="questionText" id={"questionType" + (i+1) + "." + (j+1)} rows="6" cols="50" onChange={(e) => this.handleQuestions(e, i, j)} value={this.state.questionsArr[i][j].questionText}></textarea>
                                                                </div>
                                                                ...
                                                                {   
                                                                    this.state.questionsArr[i][j].questionType === "MCQ" && 
                                                                        ...
                                                                        <div className="form-group col-sm-12 radioBtns" id={"radioBtns" + (i+1) + "." + (j+1)}>
                                                                            ...
                                                                            <input type="radio" name={"mcq" + (i+1) + "." + (j+1)} id={"opt1-" + (i+1) + "." + (j+1)} value="1" onChange={(e) => this.handleQuestions(e,i, j )} checked={this.state.questionsArr[i][j].correctAns === "1" ? true : false }></input>
                                                                            {" "}
                                                                            <label htmlFor={"opt1-" + (i+1) + "." + (j+1)}>
                                                                            
                                                                                <input type="text" name="lbl1" onChange={(e) => this.handleQuestions(e, i, j)}  id={"lbl1-" + (i+1) + "." + (j+1)} value={this.state.questionsArr[i][j].options.opt1}></input>
                                                                                
                                                                            </label><br />

                                                                            <input type="radio" name={"mcq" + (i+1) + "." + (j+1)} id={"opt2-" + (i+1) + "." + (j+1)} value="2" onChange={(e) => this.handleQuestions(e,i, j )} checked={this.state.questionsArr[i][j].correctAns === "2" ? true : false }></input>
                                                                            {" "}
                                                                            <label htmlFor={"opt2-" + (i+1) + "." + (j+1)}>
                                                                            
                                                                                <input type="text" name="lbl2" onChange={(e) => this.handleQuestions(e, i, j)} id={"lbl2-" + (i+1) + "." + (j+1)} value={this.state.questionsArr[i][j].options.opt2}></input>
                                                                                
                                                                            </label><br />
                                                                            

                                                                            <input type="radio" name={"mcq" + (i+1) + "." + (j+1)} id={"opt3-" + (i+1) + "." + (j+1)} value="3" onChange={(e) => this.handleQuestions(e,i, j )} checked={this.state.questionsArr[i][j].correctAns === "3" ? true : false }></input>
                                                                            {" "}
                                                                            <label htmlFor={"opt3-" + (i+1) + "." + (j+1)}>
                                                                                
                                                                                <input type="text" name="lbl3" onChange={(e) => this.handleQuestions(e, i, j)} id={"lbl3-" + (i+1) + "." + (j+1)} value={this.state.questionsArr[i][j].options.opt3}></input>
                                                                                
                                                                            </label><br />
                                                                            
                                                                            <input type="radio" name={"mcq" + (i+1) + "." + (j+1)} id={"opt4-" + (i+1) + "." + (j+1)} value="4" onChange={(e) => this.handleQuestions(e,i, j )} checked={this.state.questionsArr[i][j].correctAns === "4" ? true : false }></input>
                                                                            {" "}
                                                                            <label id={"lbl4-" + (i+1) + "." + (j+1)} htmlFor={"opt4-" + (i+1) + "." + (j+1)}>
                                                                                
                                                                                <input type="text" name="lbl4" onChange={(e) => this.handleQuestions(e, i, j)} id={"lbl4-" + (i+1) + "." + (j+1)} value={this.state.questionsArr[i][j].options.opt4}></input>
                                                                            ...
                                                                            </label><br />
                                                                            {
                                                                                this.state.questionsArr[i][j].optCount > 4 && this.state.questionsArr[i][j].optArr.map((o, l) => {
                                                                                    ...
                                                                                    return(
                                                                                        ...
                                                                                        <div>
                                                                                            <input type="radio" name={"mcq" + (i+1) + "." + (j+1)} id={"opt4-" + (i+1) + "." + (j+1)} value={5+l} onChange={(e) => this.handleOptions(e, i, j)} checked ={this.state.questionsArr[i][j].correctAns === (5+l).toString() ? true : false }></input>
                                                                                            {" "}
                                                                                            <label htmlFor={"opt" + (5+l) + "-" + (i+1) + "." + (j+1)}>
                                                                                                
                                                                                                <input type="text" name={"lbl" + (5+l)} onChange={(e) => this.handleOptions(e, i, j)} id={"lbl" + (5+l) + "-" + (i+1) + "." + (j+1)} value={this.state.questionsArr[i][j].options["opt" + (5+l)]}></input>
...

                                                                {
                                                                    ...
                                                                    <div className="form-group col-sm-12 blankAns" id={"blankAns" + (i+1) + "." + (j+1)}>
                                                                        ...
                                                                        <input required type="text" onChange={(e) => this.handleQuestions(e, i, j)} id={"fill" + (i+1) + "." + (j+1)} name="fillAns" value={this.state.questionsArr[i][j].correctAns}></input>
                                                                    </div>

                                                                }
                                                                <div className="form-group col-sm-12">
                                                                    <label htmlFor="marks_plus">Marks for correct answer</label>
                                                                    <input required type="number" className="form-control" name="marks_plus" id={"marks_plus" + (i+1) + "." + (j+1)} onChange={(e) => this.handleQuestions(e, i, j)} placeholder="Marks for correct answer" value={this.state.questionsArr[i][j].marks_plus}></input> 
                                                                </div>
                                                                <div className="form-group col-sm-12">
                                                                    <label htmlFor="marks_minus">Negative marking</label>
                                                                    <input required type="number" className="form-control" name="marks_minus" id={"marks_minus" + (i+1) + "." + (j+1)} onChange={(e) => this.handleQuestions(e, i, j)} placeholder="Negative marking" value={this.state.questionsArr[i][j].marks_minus}></input> 
                                                                </div>
                                                                {/* <div className="form-group col-sm-12">
                                                    ...
                                                    <div className="form-group col-sm-12 text-center">
                                                        <a className="btn btn-info text-white" onClick={this.submitSection}>Confirm Section</a>
                                                    </div>   
                                                </div>
                        ...
                        <div className="form-row">
                            <div className="form-group mt-5 col-sm-12">
                                ...
                                <button type="submit" className="btn btn-success col-2 text-white float-right">Submit</button>
                            </div>
                        </div>
