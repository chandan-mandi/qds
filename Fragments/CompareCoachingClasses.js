...
function CompareCoachingClasses() {
    ...
    const OthersData = {
        ...
        doubtSolving: "Run behind Faculties!",
        demoSession: "Yes",
            ...
            <div className="tabe">
                ...
                className="table-header">
                    ...
                    <div className="table-cell head head-others">
                        <h5>Other Leading Coaching Classes</h5>
                    </div>
                </div>
                ...
                <Fade direction="up" cascade={true} triggerOnce={false} duration={200}>
                    ...
                    className="table">
                        ...
                        <div className="table-cell">
                            {QDSProData.batchSize}
                        </div>
                        <div className="table-cell">
                            {OthersData.batchSize}
                        </div>
...
export default CompareCoachingClasses;
