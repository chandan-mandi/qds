...
const CoachingClassPackages = (props) => {
    ...
    let HomeTutoringPackagesArray = [
        {
            ref_id: 0,
            title: 'GMAT Home Comprehensive Package',
            pointers: [
                " Learn from GMAT 99%iler",
                " 65+ Hours of Rigorous Home Training",
        ...
        {
            ref_id: 1,
            title: 'CAT Home Comprehensive Package',
            pointers: [
                " Learn from CAT 99+%iler",
                " 125+ Hours of Rigorous Home Training",
                " Unlimited Access to 24 x 7 Online Doubt Solving Platform",
        ...
        {
            ref_id: 2,
            title: 'MAH-CET Home Comprehensive Package',
            pointers: [
                " Learn from CAT 99+%iler",
        ...
        {
            ref_id: 3,
            title: 'GRE Home Comprehensive Package',
            pointers: [
                " Learn from GMAT 99%iler",
                " 65+ Hours of Rigorous Home Training",
                " Unlimited Access to 24 x 7 Online Doubt Solving Platform",
        ...
        {
            ref_id: 4,
            title: 'SAT Home Comprehensive Package',
            pointers: [
                " Learn from GMAT 99%iler",
                " 65+ Hours of Rigorous Home Training",
                " Unlimited Access to 24 x 7 Online Doubt Solving Platform",
        ...
        {
            ref_id: 5,
            title: 'IELTS Home Comprehensive Package',
            pointers: [
            ...
            <Slider className="testimonial-slide text-center" {...settings} ref={slider_ref} style={{ width: "90%" }} >
                {
                    ...
                    HomeTutoringPackagesArray.map((p, i) => (
                                                    ...
                                                    <div >
                                                        ...
                                                        {p.ref_id !== 5 && (
                                                            ...
                                                            href={{
                                                                ...
                                                                query: {category: 4, select: p.ref_id }
                                                            }}
                                                        >
                                                            <button
                                                                className="btn btn-primary btn-lg"
