...
const LiveOnlinePackages = (props) => {
    ...
    let LiveOnlinePackagesArray = [
        ...
        {
            ref_id: 5,
            title: "IELTS Online Comprehensive Package",
            pointers: [
            ...
            <Slider className="testimonial-slide text-center" {...settings} ref={slider_ref} style={{ width: "90%" }} >
                {
                    ...
                    LiveOnlinePackagesArray.map((p, i) => (
                                                    ...
                                                    <p className="white-text addon-sub-text text-left">
                                                        {
                                                            p.pointers.map((pointer, i) => (
                                                                <p key={i} style={{ fontSize: '20px' }} ><i className="fa fa-hand-o-right"></i> {pointer} </p>
                                                            ))
                                                        }
                                                    </p>
                                                    ...
                                                    <div >
                                                        ...
                                                        {p.ref_id !== 5 && (
                                                            ...
                                                            href={{
                                                                ...
                                                                query: {category: 2 ,select: p.ref_id }
                                                            }}
                                                        >
                                                            <button
                                                                className="btn btn-primary btn-lg"
...
export default LiveOnlinePackages;
